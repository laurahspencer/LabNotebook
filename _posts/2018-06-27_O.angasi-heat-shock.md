...
NOTE: entry not completed - lots of images/data to add still! 
...
I used two [NEED HEATER INFO] to heat a fresh water bath to ~37C, and set a bucket of aerated seawater in the bath to heat overnight. In the morning I immersed 3 groups of oysters in the heated bath, and tested each at 30, 60 and 120 minutes in the water (n=7 per duration): 
...
Temperature in the bucket during the trial: 
...
[survival data from full-strength heat shock trial] 
